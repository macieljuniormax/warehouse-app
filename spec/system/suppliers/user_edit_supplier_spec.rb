...
describe 'Usuário edita um fornecedor' do
  it 'a partir da página de dealhes' do
    ...
    expect(page).to have_field('CNPJ', with: '434472146')
  ...
  it 'com sucesso' do
    # Arrange
    Supplier.create!(corporate_name: 'ACME LTDA SSA', brand_name: 'ACMESSA', registration_number: '434472149', 
